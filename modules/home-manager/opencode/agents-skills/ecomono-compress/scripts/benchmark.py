...
def main():
    ...
    # Glob mode: repo_root/tests/ecomono-compress/
    # __file__ lives at <repo_root>/skills/ecomono-compress/scripts/benchmark.py
    # Walk up four dirs: scripts → ecomono-compress → skills → repo_root.
    tests_dir = Path(__file__).resolve().parents[3] / "tests" / "ecomono-compress"
