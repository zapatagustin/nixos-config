...
- Save the registry to ecomono-memory as `topic_key: skill-registry` when available.
...
4. Persist to ecomono-memory when available using `title: skill-registry`, `topic_key: skill-registry`, `type: config`.
